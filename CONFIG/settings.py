...
SECRET_KEY = 'django-insecure-h%=ws&5@o9(0(7h$d4%a(v0v-ohf((3$_qal!+-ww1d=#1oq4n'
...
MIDDLEWARE = [
	'apps.entidades.middleware.TemplateErrorMiddleware',
	...
	'apps.entidades.middleware.check_solicitudes_en_espera',
]
